...
public abstract class AbstractRESTController<T extends TransferObject> {
    ...
    public ResponseEntity<T> show(@PathVariable("id") String id) {
        try {
    ...
    public ResponseEntity<List<T>> delete(@PathVariable("id") String id) {
    ...
    protected abstract T initializeShowTO(String id);
     ...
     */
    protected abstract List<T> deleteTO(String id);
}
