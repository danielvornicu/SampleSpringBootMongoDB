...
public abstract class AbstractSearchEditController<T extends TransferObject,  F extends BaseForm<T>> extends BaseController{
    ...
    public String show(@PathVariable String id, F form, ModelMap model) {
    ...
    public String edit(@PathVariable String id, F form, ModelMap model) {
    ...
    public String update(@PathVariable String id, @Valid F form, BindingResult result, ModelMap model, SessionStatus status) {
...
/*        try {
     ...
     * @param model le model
     */
    protected abstract void initializeShowTO(String id, F form, ModelMap model);
     ...
     * @param model le model
     */
    protected abstract void initializeEditTO(String id, F form, ModelMap model);
     ...
     * @param model le model
     */
    protected abstract void deleteTO(String id, ModelMap model);
