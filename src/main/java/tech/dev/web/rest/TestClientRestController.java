...
public class TestClientRestController extends AbstractSearchEditController<ClientTO, ClientForm> {
    ...
    @Override
    protected void initializeShowTO(String id, ClientForm form, ModelMap model) {
    ...
    @Override
    protected void initializeEditTO(String id, ClientForm form, ModelMap model) {
        try {
            //ClientTO client = clientService.findByIdFillTO(id);
    ...
    @Override
    protected void deleteTO(String id, ModelMap model) {
